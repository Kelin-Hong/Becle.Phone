...
{
       [Table]
        public class PostTrendTable : INotifyPropertyChanging, INotifyPropertyChanged
        {
            private int id;
            ...
            private string postAffect;
            [Column]
            public string PostAffect
            {
                get { return postAffect; }
                set
                {
                    if (postAffect != value)
                    {
                        OnPropertyChanging("PostAffect");
                        postAffect = value;
                        OnPropertyChanged("PostAffect");
                    }
                }
            }
